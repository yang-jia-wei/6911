<?php require APP_ROOT.'public/head.php'?>
    <div class="container main">
        ...
        <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
            <div class="list_box">
                <h2 class="left_h2"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">制品</font></font></h2>

                <div class="product_list product_list2">
                    <?php $perpage=3;$offset=($p-1)*$perpage;
                    $goods = M()->table('index_goods n,index_relevance r')->where('r.classify_id ='.$classify_id.' and r.content_id=n.goods_id and n.goods_classify_id=216')->order('date desc')->limit($offset,$perpage)->select();
                    ...
                    foreach($goods as $k=>$v){  ?>
                        <div class="col-sm-4 col-md-4 col-mm-6 product_img" style="transition: all 1s ease 0s, opacity 1.5s ease 0s;">
                            <a href="<?php echo content_url($v['type_id'],$v['goods_id']);?>"><img src="<?php echo $v['goods_img'];?>" class="img-thumbnail" alt="<?php echo $v['goods_name'];?>"></a>
