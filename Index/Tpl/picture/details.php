<?php require APP_ROOT.'public/head.php'?>
    <div class="container main">
        ...
        <div class="path_bg">
            <!--            接值（$good_id）-->
            <?php $picture=M('picture')->where(array('picture_id'=>$content_id))->find();?>
        ...
        <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
            <div class="list_box">
                <h2 class="left_h2"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $picture['picture_name']?></font></font></h2>
                <!-- showpic -->
                ...
                <div class="col-sm-12 col-md-6 showpic_box">
                    <div class="bx-wrapper" style="max-width: 100%;">
                        <div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 359px;"><ul class="showpic_flash" style="width: 315%; position: relative; transition-duration: 0s; transform: translate3d(-423px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; width: 383px;" class="bx-clone"><a class="example-image-link" href="" data-lightbox="example-set" target="_blank"><img class="example-image" src="" alt="这是测试产品名称"></a></li>
                                <li style="float: left; list-style: none; position: relative; width: 383px;"><a class="example-image-link" href="" data-lightbox="example-set" target="_blank">
                                        <!--                                        大图-->
                                        <img class="example-image" src="<?php echo $picture['picture_img']?>" alt="这是测试产品名称"></a></li>
                                ...
                                <li style="float: left; list-style: none; position: relative; width: 383px;" class="bx-clone"><a class="example-image-link" href="" data-lightbox="example-set" target="_blank">
                                        <img class="example-image" src="" alt="<?php echo $picture['name']?>"></a></li>
                            </ul>
                        </div>
                    ...
                    <div id="pic-page">
                        <!--                        小图-->
                        <a data-slide-index="0" class="active"><img src="<?php echo $picture['picture_img']?>" alt="名称"></a>

                    </div>
                </div>
                <!-- product_info -->
<!--                <div class="col-sm-12 col-md-6 proinfo_box">-->
<!--                    <h1 class="product_h1"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> --><?php //echo $picture['picture_name'];?><!--</font></font></h1>-->
<!--                    <ul class="product_info">-->
<!--                        --><?php //echo $picture['picture_intro'];?>
<!--                        <li>-->
...
<!--                </div>-->
                <div class="product_con">
                    <?php echo $picture['picture_content'];?>
                </div>
                <?php  $picture_gt = M()->table('index_picture n,index_relevance r')->where('r.classify_id ='.$classify_id.' and n.date > '.$picture['date'].' and r.content_id=n.picture_id')->order('date asc')->find();  if(!empty($picture_gt)){?>
                    <div class="f14464847355"><a class="f14464847356" href="<?php echo content_url($picture_gt['type_id'],$picture_gt['picture_id']) ?>">上一篇：<?php echo $picture_gt['picture_name'];?></a></div>
                <?php }?>
                <?php  $picture_lt = M()->table('index_picture n,index_relevance r')->where('r.classify_id ='.$classify_id.' and n.date < '.$picture['date'].' and r.content_id=n.picture_id')->order('date desc')->find();  if(!empty($picture_lt)){?>
                    <div class="f14464847355"><a class="f14464847356" href="<?php echo content_url($picture_lt['type_id'],$picture_lt['picture_id']) ?>">下一篇：<?php echo $picture_lt['picture_name'];?></a></div>
                <?php }?>
            ...
            <div class="list_related">
                ...
                <div class="product_list related_list">
                    <?php $picture2=M()->table('index_picture n,index_relevance r')->where('r.classify_id =222 and r.content_id=n.picture_id')->order('date desc')->select();foreach($picture2 as $k2=>$v2){?>
                        <div class="col-sm-4 col-md-3 col-mm-6 product_img">
                            <a href=""><img src="<?php echo $v2['picture_img']?>" class="img-thumbnail" alt=""></a>
                            <p class="product_title"><a href="http://demo.weboss.hk/h105/product/html/?136.html" title=""><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $v2['picture_name']?></font></font></a></p>
                        </div>
                    <?php }?>
                </div>
            </div>
